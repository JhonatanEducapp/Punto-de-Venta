...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="black" data-image="../assets/img/home-2.jpg">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="productos.php">
                            <i class="fab fa-free-code-camp mr-2 fa-2x"></i>
                            <p> Carne</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="fyv.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="bebidas.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="agregar_pro.php">
                            <i class="fa fa-plus  mr-2 fa-2x"></i>
                            <p> Agregar Productos</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="compras.php">
                            <i class="fas fa-shopping-basket mr-2 fa-2x"></i>
                            <p> Compra</p>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="graficas.php">
                            <i class="fa fa-signal mr-2 fa-2x"></i>
                            <p> Estadisticas</p>
                        </a>
                    </li>
                </ul>
